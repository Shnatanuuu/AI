...
def create_photos_of_faults_table(language, chinese_font=None):
    """Create Photos of Faults table for PDF - INSPIRED BY THE EXAMPLE CODE"""
    # Define data for the Photos of Faults table
    if language == "Mandarin":
        # Use proper Chinese font
        font_name = chinese_font if chinese_font else 'Helvetica'
        ...
        data = [
            # Title row
            ['PHOTOS OF FAULTS - 缺陷照片', ''],
            
            # MINOR section header
            ['MINOR 次要问题', ''],
            
            # MINOR items - 2 columns with photo spaces
            ['1  Clean 清洁度', '2  Wrinkle 皱'],
            ['', ''],  # Photo space row 1
            ['', ''],  # Photo space row 2
            ['', ''],  # Photo space row 3
            
            ['3  Off center 歪', '4  Heel high mismated 后跟高低'],
            ['', ''],  # Photo space row 4
            ['', ''],  # Photo space row 5
            ['', ''],  # Photo space row 6
            ...
            # MAJOR items - 2 columns with photo spaces
            ['1  Wrapping wrinkle 包边皱', '3  Gapping 开胶'],
            ['', ''],  # Photo space row 7
            ['', ''],  # Photo space row 8
            ['', ''],  # Photo space row 9
            ['', ''],  # Photo space row 10
            ...
            ['3  Glue over 溢胶', '4  Rough damage shoe 帮舟打磨高'],
            ['', ''],  # Photo space row 12
            ['', ''],  # Photo space row 13
            ['', ''],  # Photo space row 14
            ['', ''],  # Photo space row 15
    ...
    # Row heights - similar to example
    row_heights = [
        25,  # Title
        20,  # MINOR header
        20,  # Item 1-2
    ...
    style = TableStyle([
        ...
        ('SPAN', (0, 0), (1, 0)),
        ('FONTSIZE', (0, 0), (1, 0), 14),
        ('FONTNAME', (0, 0), (1, 0), chinese_font if language == "Mandarin" and chinese_font else 'Helvetica-Bold'),
        ...
        ('SPAN', (0, 1), (1, 1)),
        ('FONTSIZE', (0, 1), (1, 1), 11),
        ('FONTNAME', (0, 1), (1, 1), chinese_font if language == "Mandarin" and chinese_font else 'Helvetica-Bold'),
        ('ALIGN', (0, 1), (1, 1), 'LEFT'),
        ...
        ('FONTNAME', (0, 10), (1, 10), chinese_font if language == "Mandarin" and chinese_font else 'Helvetica-Bold'),
        ...
        ('FONTNAME', (0, 21), (1, 21), chinese_font if language == "Mandarin" and chinese_font else 'Helvetica-Bold'),
        ...
        ('FONTNAME', (0, 2), (1, 27), chinese_font if language == "Mandarin" and chinese_font else 'Helvetica'),
        ('ALIGN', (0, 2), (1, 27), 'LEFT'),
        ('VALIGN', (0, 2), (1, 27), 'TOP'),
